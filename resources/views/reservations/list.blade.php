	...
	<div class="row items-push">
		<div class="col-sm-7">
			<h1 class="page-heading">
				@if(isset($today))
					Today's Check-Ins<small></small>
				@else
					All Reservations<small></small>
				@endif
			</h1>
		</div>
...
<div class="block">
	...
	<div class="block-content">
		<div class="pull-right">
			...
			@if(!isset($today))
			<a href="{{url('/reservations/today')}}" class="btn btn-sm btn-primary"><i class="fa fa-calendar-check-o"></i> View Today's Check-Ins</a>
			@endif
		</div>
		<br/><br/>
		...
		<table class="table table-bordered table-hover table-striped js-dataTable-full-pagination">
			<thead>
				<tr>
					...
					<th class="hidden-xs">Check-In Date</th>
					<th class="hidden-xs">Check-Out Date</th>
							...
							<div class="block block-themed block-transparent remove-margin-b">
								...
								<div class="block-content">
									<div>
										...
										<div class="form-group">
											<div class="">Room Price: <b>{{number_format($reservation->room->price,2)}}</b></div>
										</div>
										<div class="form-group">
