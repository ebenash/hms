...
Route::prefix('admin')->group(function(){
    ...
    Route::get('/reservations/filter', 'ReservationsController@filter')->name('reservations-filter');
    ...
    Route::post('/rooms/availablerooms/{id}', 'RoomsController@get_available_rooms')->name('get-available-rooms');
    ...
    Route::get('/accounting/sale/filter', 'AccountingController@sale_filter')->name('sale-filter');
    ...
    Route::get('/reports/filter', 'ReportsController@reportfilter')->name('reports-filter');
