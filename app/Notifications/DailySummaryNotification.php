...
class DailySummaryNotification extends Notification implements ShouldQueue
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->line(new HtmlString('<table border="2px"><tbody><tr><td>#</td><td><strong>Guest</strong></td><td><strong>Rooms</strong></td><td><strong>Days</strong></td><td><strong>Type</strong></td><td><strong>Total</strong></td></tr>'.$this->summary->yesterdays_res_body.'</tbody></table>'))
            ...
            ->line(new HtmlString('<table border="2px"><tbody><tr><td>#</td><td><strong>Guest</strong></td><td><strong>Room Type</strong></td><td><strong>Room</strong></td><td><strong>Total</strong></td></tr>'.$this->summary->yesterdays_detail_body.'</tbody></table>'))
            ...
            ->line(new HtmlString('<table border="2px"><tbody><tr><td>#</td><td><strong>Guest</strong></td><td><strong>Rooms</strong></td><td><strong>Check-in</strong></td><td><strong>Check-out</strong></td></tr>'.$this->summary->stay_over_res_body.'</tbody></table>'))
            ...
            ->line(new HtmlString('<table border="2px"><tbody><tr><td>#</td><td><strong>Guest</strong></td><td><strong>Rooms</strong></td><td><strong>Check-in</strong></td><td><strong>Check-out</strong></td><td><strong>Type</strong></td><td><strong>Total</strong></td></tr>'.$this->summary->checking_in_res_body.'</tbody></table>'))
            ...
            ->line(new HtmlString('<table border="2px"><tbody><tr><td>#</td><td><strong>Guest</strong></td><td><strong>Room Type</strong></td><td><strong>Room</strong></td><td><strong>Check-in</strong></td><td><strong>Check-out</strong></td><td><strong>Total</strong></td></tr>'.$this->summary->checking_in_detail_body.'</tbody></table>'))
            ...
            ->line(new HtmlString('<table border="2px"><tbody><tr><td>#</td><td><strong>Guest</strong></td><td><strong>Rooms</strong></td><td><strong>Check-in</strong></td><td><strong>Check-out</strong></td><td><strong>Type</strong></td><td><strong>Total</strong></td></tr>'.$this->summary->checking_out_res_body.'</tbody></table>'))
            ...
            ->line(new HtmlString('<table border="2px"><tbody><tr><td>#</td><td><strong>Guest</strong></td><td><strong>Room Type</strong></td><td><strong>Room</strong></td><td><strong>Check-in</strong></td><td><strong>Check-out</strong></td><td><strong>Total</strong></td></tr>'.$this->summary->checking_out_detail_body.'</tbody></table>'))
